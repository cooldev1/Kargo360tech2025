...
public class HSCodeMasterListingPage extends TestBase {
	...
	// Open Orgnaze and Masters
		...
		@FindBy(xpath = "//a[@href='/hs-code/list']")
		WebElement HSCode;
	
	
	// Initializing the Page Objects:
	public HSCodeMasterListingPage() {
	...
	public String veryfyHSCodeLisingpage(){
