...
public class StateMasterListingPage extends TestBase {
	...
	// Open Orgnaze and Masters
		...
		@FindBy(xpath = "//a[@href='/state/list']")
		WebElement State;
	
	
	// Initializing the Page Objects:
	public StateMasterListingPage() {
	...
	public void clickOnStateListingPage() throws InterruptedException{
	...
	public String veryfyStateLisingpage(){
